...
> [Versión en **inglés**](https://github.com/eCaller/eCallerEpidemiaBackEnd/blob/master/README-EN.md)
...
La documentación funcional de la solución software se encuentra disponible en el enlace [Wiki-ReferenciaFuncional](https://github.com/eCaller/eCallerEpidemiaBackEnd/wiki/documentación-funcional).

## Descripción técnica

La documentación técnica de la solución software se encuentra disponible en el enlace [Wiki-ReferenciaTecnica](https://github.com/eCaller/eCallerEpidemiaBackEnd/wiki/documentación-técnica).
